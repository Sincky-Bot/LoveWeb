(function(window){
    ...
    Footer.prototype = {
        draw: function() {
            ...
            ctx.save();
            ctx.strokeStyle = 'rgb(240, 145, 160)';
    ...
    Tree.prototype = {
        ...
        initFooter: function() {
            ...
            var width = footer.width || this.width + 20;
        ...
        jump: function() {
            ...
            if ((blooms.length && blooms.length < 3) || !blooms.length) {
                ...
                for (var i = 0; i < random(1,2); i++) {
                    blooms.push(this.createBloom(width, height, r, figure,
                        null, 1, null,
                        1,
                        new Point(random(0, width/2), height + 20), random(200,300)));
                }
            }
        }
    }
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
        	ctx.beginPath();
        	ctx.fillStyle = 'rgb(195, 131, 131)';
            ctx.shadowColor = 'rgb(195, 131, 131)';
            ctx.shadowBlur = 2;
        	ctx.moveTo(p.x, p.y);
